						...
						<FormItem>
							...
							<FormControl>
								<Input
									{...field}
									className='bg-primary/10'
									placeholder='https://www.linkedin.com/in/shomuratov-mirzobek-mijoo-6b036227a/'
								/>
							</FormControl>
						</FormItem>
					)}
						...
						<FormItem>
							...
							<FormControl>
								<Input
									{...field}
									className='bg-primary/10'
									placeholder='https://github.com/M1rzo99'
								/>
							</FormControl>
						</FormItem>
					)}
						...
						<FormItem>
							...
							<FormControl>
								<Input
									{...field}
									className='bg-primary/10'
									placeholder='https://youtube.com/educa'
								/>
							</FormControl>
						</FormItem>
					)}
