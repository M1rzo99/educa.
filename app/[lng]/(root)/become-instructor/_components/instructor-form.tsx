...
function InstructorForm() {
  ...
  // /en/... /uz/... dan joriy locale ni olamiz
  ...
  const thirdForm = () => {
    const onSubmit = async (values: z.infer<typeof bioSchema>) => {
      ...
      // MUHIM: instruktorlikni aniq yoqamiz
      const upd = updateUser({
        ...
        .then(() => {
          // Agar “rahmat” ekranini ko‘rsatmoqchi bo‘lsangiz:
          // setStep(4)
          // darhol dashboardga olib ketamiz:
          router.replace(`/${lng}/instructor`)
        })
        .finally(() => setLoading(false))

      // Ixtiyoriy: xabar yuborish (agar backend shu keyni tarjima qilsa)
    ...
    return (
      <div className='flex flex-col items-center justify-center'>
        ...
        <Button className='mt-2' asChild>
          <Link href={`/${lng}/profile/notifications`}>
